...
function sendSms($to,$from,$msg,$id,$schedule) {
                $account = "unigran.hg";  // ---> preencher o nome da conta
                $code = "719EgBeegy";   // ---> preencher o código da conta
...
//$schedule = date();
$corposms = 'teste unigran.hg';
$cellPhone ='556796475018';
$retorno = sendSms($cellPhone,"Sistema Acadêmico",$corposms,"456",false);
