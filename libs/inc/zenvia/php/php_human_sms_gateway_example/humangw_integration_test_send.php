...
// Funзгo para Envio de SMS Individual
function sendSms($to,$from,$msg,$id,$schedule) {
	$account = "nome_da_conta";  // ---> preencher o nome da conta
	$code = "codigo_da_conta";   // ---> preencher o cуdigo da conta
...
// Classe para requisiзгo HTTP via socket
class HTTPRequest
{
   var $_fp;        // HTTP socket
   var $_url;        // full URL
...
$schedule = date();
$retorno = sendSms("550084220483","Human","Conteudo da Msg","",$schedule);
echo $retorno;
