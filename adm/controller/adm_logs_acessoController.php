...
if (!empty($_GET['cmd']) || !empty($_POST['cmd'])) {
	$control = new adm_logs_acessoController();  // ****-
}

//CLASS ****-
class adm_logs_acessoController {
	...
	function __construct() {
		...
		$this->core->includeController('adm_logs_acesso',$this->dir_app); //incluo model ****-

		//INSTANCIO
		$this->funcoes           = new funcoes();     //Instancio Funções
		$this->model             = new adm_logs_acessoModel();  //Instancio Model ****-
...
//***************************************************************************************************************************************************************
		function carrego_parametros(){
            ...
            $this->url_pagina                    = "adm_logs_acesso"; //Url da página
            $this->nome_pagina_singular          = "Log"; // Nome da página singular
            $this->nome_pagina_plural            = "Admin Logs de Acessos"; // Nome da página plural
            ...
            $this->btns_acoes['title_campo_pesquisa'] = 'Usuário ou ação'; // Parametros de pesquisa
...
//***************************************************************************************************************************************************************
	function view($parametro){
		...
		//===========================================================
		//OUTROS INCLUDES ****-
		$this->funcoes->set_array(0,'include',"graficos/grafico_total_logs_acesso_usuarios.phtml")
...
//***************************************************************************************************************************************************************
		function monto_conteudo_html_pagina($param){
			...
			if($param == 'campos_html_imprimir'){
				...
				$this->funcoes->set_array(1,'input_id','usuario');
				$this->funcoes->set_array(1,'input_name','campos_imprimir[]');
				$this->funcoes->set_array(1,'input_class','');
				$this->funcoes->set_array(1,'input_title','');
				$this->funcoes->set_array(1,'input_value','usuario'); //value do campo
				$this->funcoes->set_array(1,'input_checked','checked'); //checked ou ""
				...
				$this->funcoes->set_array(3,'input_id','ip');
				$this->funcoes->set_array(3,'input_name','campos_imprimir[]');
				$this->funcoes->set_array(3,'input_class','');
				$this->funcoes->set_array(3,'input_title','');
				$this->funcoes->set_array(3,'input_value','ip'); //value do campo
				$this->funcoes->set_array(3,'input_checked','checked'); //checked ou ""
				$this->funcoes->set_array(3,'input_texto_checkbox','IP'); //Texto
				$this->funcoes->set_array(4,'input_id','so');
				$this->funcoes->set_array(4,'input_name','campos_imprimir[]');
				$this->funcoes->set_array(4,'input_class','');
				$this->funcoes->set_array(4,'input_title','');
				$this->funcoes->set_array(4,'input_value','so'); //value do campo
				$this->funcoes->set_array(4,'input_checked','checked'); //checked ou ""
				$this->funcoes->set_array(4,'input_texto_checkbox','SO'); //Texto
				$this->funcoes->set_array(5,'input_id','navegador');
				$this->funcoes->set_array(5,'input_name','campos_imprimir[]');
				$this->funcoes->set_array(5,'input_class','');
				$this->funcoes->set_array(5,'input_title','');
				$this->funcoes->set_array(5,'input_value','navegador'); //value do campo
				$this->funcoes->set_array(5,'input_checked','checked'); //checked ou ""
				$this->funcoes->set_array(5,'input_texto_checkbox','Navegador'); //Texto
				$this->funcoes->set_array(6,'input_id','idioma');
				...
				$this->funcoes->set_array(6,'input_value','idioma'); //value do campo
				$this->funcoes->set_array(6,'input_checked','checked'); //checked ou ""
				$this->funcoes->set_array(6,'input_texto_checkbox','Idioma'); //Texto
				$this->funcoes->set_array(7,'input_id','criado');
				...
				$this->funcoes->set_array(7,'input_value','criado'); //value do campo
				$this->funcoes->set_array(7,'input_checked','checked'); //checked ou ""
				$this->funcoes->set_array(7,'input_texto_checkbox','Cadastrado'); //Texto
				$valores_checkbox = $this->funcoes->get_array();
			...
			if($param == 'listagem'){
				...
				$this->funcoes->set_array(7,'value',"ACAO CRESCENTE");
				$this->funcoes->set_array(8,'value',"ACAO DECRESCENTE");
				...
				$mont_html->set_array(0,'condicoes',"[bd:acao] == 'Login'"); // condições do if - aceita campo do banco [bd:campo] ou variavel smarty [sm:variavel]
				$mont_html->set_array(0,'cod_if',"Entrou no Sistema"); // código do bloco if - aceita campo do banco [bd:campo] ou variavel smarty [sm:variavel]
				...
				$acao = $mont_html->if_else_smarty();
				$mont_html->set_array(0,'condicoes',"[bd:acao] == 'Logoff'"); // condições do if - aceita campo do banco [bd:campo] ou variavel smarty [sm:variavel]
				$mont_html->set_array(0,'cod_if',"Saiu do Sistema"); // código do bloco if - aceita campo do banco [bd:campo] ou variavel smarty [sm:variavel]
				$mont_html->set_array(0,'cod_else',""); // código do bloco else se tiver - aceita campo do banco [bd:campo] ou variavel smarty [sm:variavel]
				$acao1 = $mont_html->if_else_smarty();
				...
				$mont_html->set_array(2,'td'," {$acao} {$acao1} "); // Coluna montada **
				...
				$mont_html->set_array(3,'td',"<strong>Ip:</strong> [bd:IP]</br><strong>SO:</strong> [bd:SO]</br><strong>Navegador:</strong> [bd:navegador]</br><strong>Idioma:</strong> [bd:idioma]"); // Coluna montada **
...
//***************************************************************************************************************************************************************
	function add_edd(){
		...
		$name_campo = $this->funcoes->anti_injection($_POST['name_campo']);
...
//***************************************************************************************************************************************************************
        function list_grafico($tipo = null) {
            ...
            //============================================================
            //GRAFICO LOGS ACESSO USUARIOS QUE MAIS ACESSAO
            if($tipo == 'total_logs_acesso_usuarios'){
                $array = $this->model->retorno_logs_acesso_usuarios_acessao();
                $rows = array();
                $table = array();
                $table['cols'] = array(
                ...
                for ($i=0; $i <count($array) ; $i++) {
                    $temp = array();
                    $temp[] = array('v' => (string) $array[$i]['nome']);
			...
			//============================================================
            //GRAFICO SO LOGS SO LOGS LOGOFF E LOGIN
            if($tipo == 'total_logs_logoff_login'){
                $array = $this->model->retorno_logs_logoff_login();
                $rows = array();
                $table = array();
                $table['cols'] = array(
	                array('id' => '', 'label' => 'Descrição', 'type' => 'string'),
                ...
                for ($i=0; $i <count($array) ; $i++) {
                    $temp = array();
                    $temp[] = array('v' => (string) $array[$i]['acao']);
                    $temp[] = array('v' => (int) $array[$i]['total']);
                    $rows[] = array('c' => $temp);
                }
                $table['rows'] = $rows;
