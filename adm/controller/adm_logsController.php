...
if (!empty($_GET['cmd']) || !empty($_POST['cmd'])) {
	$control = new adm_logsController();  // ****-
}

//CLASS ****-
class adm_logsController {
	...
	function __construct() {
		...
		$this->model             = new adm_logsModel();  //Instancio Model ****-
...
//***************************************************************************************************************************************************************
		function carrego_parametros(){
			...
			$this->btns_acoes['status_area_grafico']      = true; // Status area de graficos  [true or false]
            ...
            $this->btns_acoes['title_campo_pesquisa'] = 'Usuário, url, página ou ação'; // Parametros de pesquisa
			...
			$this->btns_acoes['class_icone_listagem']     = "fa fa-list-alt"; // Classe do icone da listagem
...
//***************************************************************************************************************************************************************
	function view($parametro){
		...
		$this->funcoes->set_array(0,'include',"graficos/grafico_navegadores_mais_utilizados.phtml")
					  ...
					  ->set_array(0,'tipo_grafico',"anel");  //tipos: anel, pizza, pizza_3d, barra_vertical, barra_horizontal
	    $this->funcoes->set_array(1,'include',"graficos/grafico_so_mais_utilizados.phtml")
					  ->set_array(1,'status_area',true) // controlo if de status
					  ->set_array(1,'col',"col-md-4") // col-md-
					  ->set_array(1,'height',"200") // height px
					  ->set_array(1,'tipo_grafico',"anel");  //tipos: anel, pizza, pizza_3d, barra_vertical, barra_horizontal
	    $this->funcoes->set_array(2,'include',"graficos/grafico_paginas_mais_utilizados.phtml")
					  ->set_array(2,'status_area',true) // controlo if de status
					  ->set_array(2,'col',"col-md-4") // col-md-
				      ->set_array(2,'height',"200") // height px
					  ->set_array(2,'tipo_grafico',"anel");  //tipos: anel, pizza, pizza_3d, barra_vertical, barra_horizontal
...
//***************************************************************************************************************************************************************
		function monto_conteudo_html_pagina($param){
			...
			if($param == 'campos_html_pesq_avancada'){
				...
				//===========================================================
				//MONTO CAMPOS
				$mont_html->set_array(0,'conteudo'," {$area_descricao} {$input_text} {$input_text2} {$select} {$area_descricao2} {$usuario} {$acao} {$url} {$pagina}");
			...
			if($param == 'listagem'){
				...
				$pesq_avanc5 = $this->funcoes->anti_injection($_POST['pesq_avanc_acao']); // Recebo dados
				$pesq_avanc6 = $this->funcoes->anti_injection($_POST['pesq_avanc_url']); // Recebo dados
				$pesq_avanc7 = $this->funcoes->anti_injection($_POST['pesq_avanc_pagina']); // Recebo dados
				...
				if(!empty($pesq_avanc5)){ $pesq_avancada['pesq_avanc_acao'] = $pesq_avanc5; }
				if(!empty($pesq_avanc6)){ $pesq_avancada['pesq_avanc_url'] = $pesq_avanc6; }
				if(!empty($pesq_avanc7)){ $pesq_avancada['pesq_avanc_pagina'] = $pesq_avanc7; }
				...
				$this->funcoes->set_array(6,'value',"URL CRESCENTE");
				$this->funcoes->set_array(7,'value',"URL DECRESCENTE");
				$this->funcoes->set_array(8,'value',"separator"); //separator
				$this->funcoes->set_array(9,'value',"PAGINA CRESCENTE");
				$this->funcoes->set_array(10,'value',"PAGINA DECRESCENTE");
				$this->funcoes->set_array(11,'value',"separator"); //separator
				$this->funcoes->set_array(12,'value',"ACAO CRESCENTE");
				$this->funcoes->set_array(13,'value',"ACAO DECRESCENTE");
				$this->funcoes->set_array(14,'value',"separator"); //separator
				$this->funcoes->set_array(15,'value',"IP CRESCENTE");
				$this->funcoes->set_array(16,'value',"IP DECRESCENTE");
				$this->funcoes->set_array(17,'value',"separator"); //separator
				$this->funcoes->set_array(18,'value',"SO CRESCENTE");
				$this->funcoes->set_array(19,'value',"SO DECRESCENTE");
				$this->funcoes->set_array(20,'value',"separator"); //separator
				$this->funcoes->set_array(21,'value',"NAVEGADOR CRESCENTE");
				$this->funcoes->set_array(22,'value',"NAVEGADOR DECRESCENTE");
				$this->funcoes->set_array(23,'value',"separator"); //separator
				$this->funcoes->set_array(24,'value',"IDIOMA CRESCENTE");
				$this->funcoes->set_array(25,'value',"IDIOMA DECRESCENTE");
				$this->funcoes->set_array(26,'value',"separator"); //separator
				$this->funcoes->set_array(27,'value',"CADASTRADO CRESCENTE");
				$this->funcoes->set_array(28,'value',"CADASTRADO DECRESCENTE");
				$this->funcoes->set_array(29,'value',"separator"); //separator
				$this->funcoes->set_array(30,'value',"MODIFICADO CRESCENTE");
				$this->funcoes->set_array(31,'value',"MODIFICADO DECRESCENTE");
				...
				$mont_html->set_array(1,'td',"{$img_usuario} [bd:nome]"); // Coluna montada **
				...
				$mont_html->set_array(2,'td',"[bd:acao]"); // Coluna montada **
				...
				$mont_html->set_array(3,'td',"<strong>Url:</strong> [bd:url]</br><strong>Pagina:</strong> [bd:pagina]"); // Coluna montada **
				...
				$mont_html->set_array(4,'td',"<strong>Ip:</strong> [bd:IP]</br><strong>SO:</strong> [bd:SO]</br><strong>Navegador:</strong> [bd:navegador]</br><strong>Idioma:</strong> [bd:idioma]"); // Coluna montada **
...
//***************************************************************************************************************************************************************
        function list_grafico($tipo = null) {
            ...
            if($tipo == 'total_so_logs_admin'){
                $array = $this->model->retorno_so_logs_adm();
                $rows = array();
                $table = array();
                $table['cols'] = array(
	                array('id' => '', 'label' => 'Descrição', 'type' => 'string'),
                ...
                for ($i=0; $i <count($array) ; $i++) {
                    $temp = array();
                    $temp[] = array('v' => (string) $array[$i]['SO']);
                    $temp[] = array('v' => (int) $array[$i]['total']);
                    $rows[] = array('c' => $temp);
                }
                $table['rows'] = $rows;
            ...
            if($tipo == 'total_paginas_logs_admin'){
                $array = $this->model->retorno_paginas_logs_adm();
                $rows = array();
                $table = array();
                $table['cols'] = array(
	                array('id' => '', 'label' => 'Descrição', 'type' => 'string'),
                ...
                for ($i=0; $i <count($array) ; $i++) {
                    $temp = array();
                    $temp[] = array('v' => (string) $array[$i]['pagina']);
                    $temp[] = array('v' => (int) $array[$i]['total']);
                    $rows[] = array('c' => $temp);
                }
                $table['rows'] = $rows;
