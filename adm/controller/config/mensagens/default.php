...
//***************************************************************************************************************************************************************
              ...
              $this->set_array(array(
                  ...
                  'sucesso_esqueci_senha_user_adm'      => 'Instruções de alteração da senha enviados com sucesso <br /> para o e-mail cadastrado no sistema. Verifique seu e-mail',
                  'erro_esqueci_senha_user_adm'         => 'O Nome de usuário informado não foi encontrado na base da dados. <br /> Verifique e tente novamente!',
                  'erro_enviar_email_esqueci_senha' => 'Erro ao alterar a senhas',
                  'erro_enviar_email_esqueci_senha_adm' => 'Erro ao redefinir a senha',
              ...
              $this->set_array(array(
                  ...
                  'sucesso_cadastro'       => '%s %s com sucesso!',
                  'sucesso_cadastro_array' => '%s de %s %s %s com sucesso!',
                  'erro_cadastro' => 'Erro ao %s %s',
                  'erro_set_form' => 'Erro ao carregar os dados do formulário',

                  'sucesso_inserir'       => '%s Inserido(a) com sucesso!',
                  'sucesso_editar'       => '%s Editado(a) com sucesso!',
                  'erro_exc_restricao'  => 'Este registro não pode ser excluído pois esta vinculado a outros!',

                  'erro_inserir'       => 'Erro ao Inserir %s!',
                  'erro_editar'       => 'Erro ao Editar %s!',
...
//***************************************************************************************************************************************************************
              ...
              $this->set_array(array(
                  ...
                  'sucesso_cadastro_array_log' => 'Sucesso ao %s %s ID: %s',
                  'erro_cadastro_array_log' => 'Erro ao %s %s ID: %s',

                  'sucesso_cadastro_log' => '%s %s com sucesso!',
                  'erro_cadastro_log' => 'Erro ao %s %s',
                  'funcao_acesso_negado' => 'Tentativa de acesso negada a função: %s',

                  'sucesso_inserir_log_adm'       => '%s Inserido com sucesso ID: %s',
                  'sucesso_editar_log_adm'       => '%s Editado com sucesso ID: %s',
                  'sucesso_excluir_log_adm'       => 'Arquivo excluído com sucesso ID: %s - Tabela: %s',
                  'erro_excluir_log_adm'       => 'Erro ao excluir arquivo. ID: %s - Tabela: %s',

                  'erro_editar_log'       => 'Erro ao Editar %s ID: %s',
              ...
              $this->set_array(array(
                  ...
                  'sucesso_cadastro_user_log'           => 'Usuário cadastrado. USERNAME %s',
