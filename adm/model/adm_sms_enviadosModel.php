<?php
	...
	**/
	...
	//CLASSE ****-
	class adm_sms_enviadosModel extends config_model_adm {
...
//***************************************************************************************************************************************************************
		function carrego_parametros(){
			$this->setTabela('adm_sms_enviados'); // Tabela ****-
		}
...
//***************************************************************************************************************************************************************
		function listagem($limit = null){
			...
			//===========================================================
			//MONTO INNER JOIN ****-
			$this->setInner('INNER JOIN adm_usuario ON adm_usuario.id = adm_sms_enviados.adm_usuario_id'); // Inner join
			...
			if(!empty($query_pesquisa) && $query_pesquisa != "Pesquisa Avançada"){
				...
				if($conf_personalizada == false){
					...
					$array_pesq[] = $this->return_where_like($tabela.'.id_sms',$query_pesquisa);
					$array_pesq[] = $this->return_where_like($tabela.'.telefone',$query_pesquisa);
...
//***************************************************************************************************************************************************************
		function detalhamento(){
			...
			$this->setColuna($this->getTabela().'.id')
				 ...
				 ->setColuna($this->getTabela().'.id_sms')
